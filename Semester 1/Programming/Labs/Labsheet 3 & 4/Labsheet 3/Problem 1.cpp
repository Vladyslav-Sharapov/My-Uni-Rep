...
int main1()
{
    ...
    distance = std::sqrt((length * length) + (width * width) + (height * height)); //square route of length^2 + width^2 + height^2 to find the diagonal(shortest distance)
    floor_area = length * width;//math
